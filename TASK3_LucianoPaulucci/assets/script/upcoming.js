...
input.addEventListener('input',()=>{
  let arrayFiltrado = filtrarPorTexto(EventosUpcoming,input.value)
  mostrarEventosUpcoming(arrayFiltrado)
})

checkBox.addEventListener('change',()=>{
  let arrayFiltradoPorCheckBox = filtrarPorCheckBox(EventosUpcoming)
  mostrarEventosUpcoming(arrayFiltradoPorCheckBox)
})

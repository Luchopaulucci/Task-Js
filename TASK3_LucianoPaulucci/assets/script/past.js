...
input.addEventListener('input',()=>{
  let arrayFiltrado = filtrarPorTexto(EventosPast,input.value)
  mostrarEventosPast(arrayFiltrado)
})

checkBox.addEventListener('change',()=>{
  let arrayFiltradoPorCheckBox = filtrarPorCheckBox(EventosPast)
  mostrarEventosPast(arrayFiltradoPorCheckBox)
})

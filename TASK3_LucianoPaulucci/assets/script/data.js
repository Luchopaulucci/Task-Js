...
checkBox.addEventListener('change',()=>{
  let arrayFiltradoPorCheckBox = filtrarPorCheckBox(data.events)
  mostrarEventos(arrayFiltradoPorCheckBox)
})
...
function filtrarPorTexto(array,texto){
  let arrayFiltradoPorTexto = array.filter(elemento => elemento.category.toLowerCase().includes(texto.toLowerCase()))
